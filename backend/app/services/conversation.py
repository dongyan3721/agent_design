...
class ConversationService:
    ...
    async def list_conversations(
        ...
        """
        items = await conversation_repo.get_conversations_by_user(            user_id=user_id,            skip=skip,
            limit=limit,
            include_archived=include_archived,
        )
        total = await conversation_repo.count_conversations(            user_id=user_id,            include_archived=include_archived,
        )
        return items, total
    ...
    async def create_conversation(
        ...
        return await conversation_repo.create_conversation(            user_id=data.user_id,            title=data.title,
        )
